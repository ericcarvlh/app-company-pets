package com.example.appcompanypets.API.ItensPedido;
...
public class AsyncItensPedido extends AsyncTask
{
    public ArrayList<DtoProduto> arrayListProduto;
    RecyclerView recyClerViewItensPedido;

    public AsyncItensPedido(RecyclerView recyClerViewItensPedido)
    {
        this.recyClerViewItensPedido = recyClerViewItensPedido;
    }
    ...
    protected Object doInBackground(Object[] objects)
    {
        ...
        String json = JsonHandler.getJson("https://appcompanypetsapi.000webhostapp.com/pedidosCliente.php");
        try
        {
    ...
    protected void onPostExecute(Object adapter)
    {
        ...
        recyClerViewItensPedido.setAdapter((RecyclerView.Adapter) adapter);
